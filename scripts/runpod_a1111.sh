...
wget -qO- https://raw.githubusercontent.com/ianscrivener/a1111-devops/main/scripts/a1111_extension.sh | bash

wget -qO- https://raw.githubusercontent.com/ianscrivener/a1111-devops/main/scripts/a1111_esrgan.sh | bash
